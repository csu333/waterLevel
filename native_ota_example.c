...
#define CONFIG_OTA_RECV_TIMEOUT 20
#define CONFIG_SKIP_COMMON_NAME_CHECK true
...
static void ota_task(void *pvParameter, char* CONFIG_FIRMWARE_UPG_URL)
{
    esp_err_t err;
